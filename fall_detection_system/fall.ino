...
const char* password = "Passward"; // Enter your WIFI Password


#define BOTtoken "botfather id" // Enter the bottoken you got from botfather
#define CHAT_ID "chatid" // Enter your chatID you got from chatid bot
